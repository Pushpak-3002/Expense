...
export const transaction = <i class="fa-solid fa-credit-card"></i>
export const categories = <i class="fa-solid fa-tags"></i>
export const account = <i class="fa-solid fa-wallet"></i>
export const settings = <i class="fa-solid fa-cog"></i>
...
export const bitcoin = <i class="fa-solid fa-bitcoin"></i>
export const piggy = <i class="fa-solid fa-piggy-bank"></i>
export const yt = <i class="fa-solid fa-youtube"></i>
export const card = <i class="fa-solid fa-cc-visa"></i>
...
export const food = <i class="fa-solid fa-bowel-food"></i>
